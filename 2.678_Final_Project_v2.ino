...
void loop()
{
  ...
  int sensR_mapped = map(sensR, 37, 909, 0, 100); //put in actual values
  int sensM_mapped = map(sensM, 33, 903, 0, 100); //put in actual values
  int sensL_mapped = map(sensL, 29, 675, 0, 100); //put in actual values
  ...
  int dual = sensL_mapped-200;

  //if (sensR_mapped - sensL_mapped > 40)
  //{
    //drive (200, dual);
  //}
  //else if (sensL_mapped - sensR_mapped > 40)
  //{
    //drive (dual, 200);
  //}
  //else
